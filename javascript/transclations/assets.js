...
let STRNG = {};
STRNG["failure"] = {"en": {"b": "No translation for the key %s", "a": "NO-TEXT"}, "pl": {"b": "Brak klucza tłumaczenia dla %s", "a": "BRAK-TEKSTU"}}
STRNG["en"] = {
  "ability": {
    "DontPickMeUp": {
    ...
    "wshield": {
      "name": "Shield",
      "description": "Partialy protects all cards in same row from weather card effects and axii, Commander's Horn will have no effect in that row. "
    },
    "quen_desc": {
    ...
    "scorch_s": {
      "name": "Scorch - Siege",
      "description": "Destroy your enemy's strongest Siege Combat unit(s) if the combined strength of all his or her Siege Combat units is 10 or more."
    },
    "scorch_a": {
      "name": "Scorch - Agilie",
      "description": "Destroy your enemy's strongest opposite row Combat unit(s) if the combined strength of all his or her opposite row Combat units is 10 or more."
    },
    "scorchstopper": {
      "description": "Prevents Scorch effects by spending 1 Shield Charge per saved card. Starts with 5 charges, cannot be recharged, and breaks if you play any Scorch card."
    },
    "agile": {
      "name": "agile",
    ...
    "sabotage": {
      "name": "sabotage",
      "description": "Send to enemy fields this cards to lower their score and draw extra 1 card(s). "
    },
    "resilience": {
      "name": "Resilience",
    ...
    "aid": {
      "name": "Call to Arms",
      "description": "Lets you and your opponent redraw 5 cards. "
    },
    "axii": {
      "name": "Witcher Signs",
      "description": "This card use Witchers tricks to cast into enemy fields Axii sign. Each card in row under Axii effect that base power is less than 5 will lose 2 power. Debuffs dont stack. Dont affect hero cards. "
    },
    "axii2_desc": {
      "name": "Axii",
      "description": "Each card in row under Axii effect that base power is less than 5 will lose 2 power. Debuffs dont stack. Dont affect hero cards "
    },
    "axii2_desc_playable": {
    ...
    "magicthegathering": {
      ...
      "description": "Choose one card out of 25 random and add it to your hand. The card cannot be picked up with the Decoy once it has been placed! This card is unstable, each turn it power will change in most of the time negative numbers (On averge power will be -3.27) "
    },
    "tgc_portal": {
      "name": "That Game Company",
      "description": "Choose one card out of max 25 Sky Faction cards and add it to your hand. The card cannot be picked up with the Decoy once it has been placed! This card is unstable, each turn it power will change in most of the time negative numbers (On averge power will be -3.27) "
    },
    "dopler": {
      "name": "Doppler",
    ...
    "reinforce": {
      "name": "Reinforce",
      "description": "Summons additional cards to board, summoned cards dont need to be in hand or deck. "
    },
    "medic": {
      "name": "medic",
    ...
    "powergain": {
      "name": "Power Gain",
      "description": "Card base power grows by 1.11 for each card in the row (excluding itself). Card base power is not affected by weather, but its bonus power is reduced by 75% under weather effects. Values are rounded down."
    },
    "bond": {
      "name": "Tight Bond",
    ...
    "keadwen_weather": {
      "description": "Play an Impenetrable Fog from your deck. If none is found, still consume leader charge. Let you skip turns, but gives your opponent 50/50 each skip to copy non-hero card from board. You need 1 charge to skip turn, you get 0.2 charges per your turn, up to 1 max charge(s) stored!"
    },
    "foltest_lord": {
    ...
    "nilf_drawmaster": {
      "description": "On use, if your hand has fewer than 3 cards, draw 1 cards from your deck, plus 1 additional card for each unit in your graveyard (up to 3 bonus cards). You start the game with 2 fewer cards in hand but you can on game start redraw extra 1 card(s)."
    },
    "temeria_call": {
      "description": "Spawn Temeria Special Forcess attack in close combat row. Commander Horn in close combat row will lost its effect but close row will be partialy protected partialy from weather effects. After use makes you pass! Can't be used when opponent passed!"
    },
    "darkness_storm_leader": {
      "description": "Spawn Darkness Storm on both sides that destroys all non-hero cards in the close row"
    },
    "turn_skiper": {
      "description": "Let you skip turns, but gives your opponent 50/50 each skip to copy non-hero card from board. You need 1 charge to skip turn, you get 0.35 charges per your turn, up to 2 max charge(s) stored!"
    },
    "d20cloner": {
      "description": "Let you roll D20 for chance to get additional card from board, but what card you can get depends on roll result. Success on even roll. You need 1 charge to roll dice, you get 0.16 charges per your turn, up to 1 max charge(s) stored!"
    },
    "gaunter_neutral_leader": {
      "description": "On use both sides will gain an additional (60%+1)  of the number of cards in the thier grave as additional cards from deck and all players start the game with 50% more cards in their hand (based on their starting number)"
    },
    "emhyr_emperor": {
    ...
    "emhyr_whiteflame2": {
      "description": "Copy opponents's leader card at start of the game, but your opponent will have addtional 2 initial redraws"
    },
    "emhyr_relentless": {
    ...
    "mediclove": {
      "description": "Both players can revive extra card when using medic card ability. "
    },
    "crach_an_craite": {
    ...
    "skellige_bond_summoner": {
      "description": "Banish a card with power greater than or equal to 4. Then create a Tight Bond card from your faction or Neutral and add it to your hand."
    }
  },
  "factions": {
    "realms": {
    ...
    "skellige": {
      "name": "Skellige",
      "description": "The strongest 2 cards from the graveyard are placed on the battlefield at the start of the third round. Revived cards lose most abilities."
    },
    "syndicate": {
      "name": "Syndicate",
    ...
    "sky": {
      "name": "Sky Kingdom",
      "description": "Keeps the strongest Unit Card out after each round. Factions full of morale boosting cards."
    }
  },
    "card": {
        ...
        "gaunter_odimm": "Gaunter O'Dimm",
        "gaunter_odimm_darkness": "Gaunter O'Dimm - Darkness",
        "cow": "Cow",
        "chort": "Bovine Defense Force",
        ...
        "francesca_hope_of_the_aen_seidhe": "Francesca Findabair - Hope of the Aen Seidhe",
    ...
    "ui": {
        "elem": {
            ...
            "op_ready": "Opponent is ready. If you are ready begin the game immediately",
            "op_faction": "Opponent changed his faction to %s",
            "op_unready": "Opponent is unReady.",
            "sync": {
                "init": "Initiating sync, wait %s seconds",
                "hold_progress": "The opponent synchronizes with the game (%x/%y), wait %ss",
            ...
            "redraw": "<color=#d5cfe3>You redrawed card</color> <color=#fa4441>%x</color> <color=#d5cfe3>for a</color> <color=#41fa66>%y</color>"
        },
        "notif": {
    "nilfgaard-wins-draws": "Nilfgaard wins draws",
    "me_win_via_nilfgaard": "Nilfgaard faction ability triggered:\nNilfgaard wins any round that ends in a draw.",
    "op_win_via_nilfgaard": "Nilfgaard faction ability triggered:\nNilfgaard wins any round that ends in a draw.",
    "op-leader": "Opponent uses leader",
    "op-white-flame": "The opponent's leader cancel\nyour opponent's Leader Ability",
    "meve_white_queen": "Lyria & Rivia leader allows both players to restore\n2 units when using the medic ability.",
    ...
    "op-coin-lambert": "Lambert says that you suck!\nThe opponent starts the game!",
    ...
    "north": "Northern Realms faction ability triggered:\nNorth draws an additional card.",
    "north-scorch-cancelled": "Northern Realms leader ability used:\nScorch ability cancelled for the rest of the round.",
    "scol_secondchance": "Scoia'tael leader passive ability triggered:\nScoia'tael draws an additional card from grave.",
    "gaunter": "Gaunter o'Dim Ability Used\nBoth sides recived additional card!",
    "scol_secondchance_necro2": "Gaunter o'Dim Ability Used\nBoth sides recived additional card!",
    "monsters": "Monsters faction ability triggered:\none Monster Unit Card stays on the board",
    "draw_end": "Gwent game can't end in a draw!\nFace opponent again till winner is picked!",
    "scol_pick": "Opponent used Scoia'tael faction ability to pick who play first!",
    "sky": "Sky Kindom faction ability triggered:\nOne Sky Kindom Unit Card stays on the board",
    "darkstorm": "Darkness is here...\nDarkness bring destruction to the close combat row!",
...
function getTranslation(key) {
    const work_lang = STRNG[lang] || STRNG.en;
    const result = getNested(work_lang, key);
