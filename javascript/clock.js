"use strict";
let STRNG_base = {};
const knowissuescript = "(()=>{const n=\"https:\/\/theredmineword.github.io\/GWENT\/web-only\",e=\"knownIssueCache_v1\",t=\"knownIssueHidden_v1\",o=document.createElement(\"style\");o.textContent=\"\\n    #ki-wrap{\\n      position:fixed;\\n      top:14px;\\n      left:50%;\\n      transform:translateX(-50%);\\n      z-index:999999;\\n      display:none;\\n      max-width:min(760px,calc(100vw - 24px));\\n    }\\n    #ki-btn{\\n      display:inline-flex;\\n      align-items:center;\\n      gap:10px;\\n      border:2px solid var(--ki-color,#DE3163);\\n      background:rgba(18,21,30,.96);\\n      color:#fff;\\n      border-radius:999px;\\n      padding:12px 16px;\\n      font:600 14px\/1.2 system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;\\n      cursor:pointer;\\n      box-shadow:0 12px 32px rgba(0,0,0,.35);\\n    }\\n    #ki-dot{\\n      width:10px;\\n      height:10px;\\n      border-radius:50%;\\n      background:var(--ki-color,#DE3163);\\n      box-shadow:0 0 0 5px color-mix(in srgb, var(--ki-color,#DE3163) 20%, transparent);\\n      flex:0 0 auto;\\n    }\\n    #ki-label{\\n      white-space:nowrap;\\n      overflow:hidden;\\n      text-overflow:ellipsis;\\n      max-width:min(70vw,520px);\\n    }\\n\\n    #ki-modal-backdrop{\\n      position:fixed;\\n      inset:0;\\n      z-index:1000000;\\n      display:none;\\n      align-items:center;\\n      justify-content:center;\\n      background:rgba(0,0,0,.58);\\n      padding:20px;\\n    }\\n    #ki-modal{\\n      width:min(760px,100%);\\n      background:rgba(18,21,30,.98);\\n      border:2px solid var(--ki-color,#DE3163);\\n      border-radius:22px;\\n      box-shadow:0 20px 60px rgba(0,0,0,.45);\\n      overflow:hidden;\\n      color:#e8ebf2;\\n      font:14px\/1.6 system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;\\n    }\\n    #ki-modal-hd{\\n      display:flex;\\n      justify-content:space-between;\\n      gap:16px;\\n      align-items:flex-start;\\n      padding:18px 20px 12px;\\n      border-bottom:1px solid rgba(255,255,255,.08);\\n    }\\n    #ki-modal-title{\\n      margin:0;\\n      font-size:24px;\\n      line-height:1.2;\\n    }\\n    #ki-modal-meta{\\n      margin-top:4px;\\n      color:#aab2c5;\\n      font-size:12px;\\n    }\\n    #ki-modal-body{\\n      padding:18px 20px 20px;\\n      white-space:pre-wrap;\\n      overflow-wrap:anywhere;\\n    }\\n    #ki-modal-ft{\\n      display:flex;\\n      justify-content:center; \/* centered redirect url *\/\\n      gap:10px;\\n      padding:0 20px 20px;\\n      flex-wrap:wrap;\\n      text-align:center;\\n    }\\n    .ki-btn2,.ki-link{\\n      appearance:none;\\n      border:0;\\n      border-radius:14px;\\n      padding:10px 14px;\\n      font:inherit;\\n      cursor:pointer;\\n      background:rgba(255,255,255,.08);\\n      color:#fff;\\n      text-decoration:none;\\n      display:inline-flex;\\n      align-items:center;\\n      justify-content:center;\\n    }\\n    .ki-btn2:hover,.ki-link:hover{\\n      background:rgba(255,255,255,.12);\\n    }\\n    .ki-primary{\\n      background:var(--ki-color,#DE3163);\\n      font-weight:700;\\n    }\\n    .ki-primary:hover{\\n      filter:brightness(1.05);\\n    }\\n  \",document.head.appendChild(o);const i=document.createElement(\"div\");i.id=\"ki-wrap\",i.innerHTML='\\n    <button id=\"ki-btn\" type=\"button\" aria-label=\"View known issue\">\\n      <span id=\"ki-dot\"><\/span>\\n      <span id=\"ki-label\">Know Issue Active \u00B7 View issue<\/span>\\n    <\/button>\\n  ',document.body.appendChild(i);const a=document.createElement(\"div\");a.id=\"ki-modal-backdrop\",a.innerHTML='\\n    <div id=\"ki-modal\" role=\"dialog\" aria-modal=\"true\" aria-labelledby=\"ki-modal-title\">\\n      <div id=\"ki-modal-hd\">\\n        <div>\\n          <h2 id=\"ki-modal-title\">Known Issue<\/h2>\\n          <div id=\"ki-modal-meta\">Last updated: \u2014<\/div>\\n        <\/div>\\n        <button class=\"ki-btn2\" id=\"ki-close\" type=\"button\">Close<\/button>\\n      <\/div>\\n      <div id=\"ki-modal-body\"><\/div>\\n      <div id=\"ki-modal-ft\"><\/div>\\n    <\/div>\\n  ',document.body.appendChild(a);const d={wrap:document.getElementById(\"ki-wrap\"),btn:document.getElementById(\"ki-btn\"),dot:document.getElementById(\"ki-dot\"),label:document.getElementById(\"ki-label\"),backdrop:a,close:document.getElementById(\"ki-close\"),title:document.getElementById(\"ki-modal-title\"),meta:document.getElementById(\"ki-modal-meta\"),body:document.getElementById(\"ki-modal-body\"),footer:document.getElementById(\"ki-modal-ft\")},r={issue:null,key:\"\",modalOpen:!1},s=()=>String(Math.floor(Date.now()\/9e5)),l=()=>crypto.randomUUID?crypto.randomUUID():`${Date.now()}-${Math.random().toString(16).slice(2)}`,c=()=>{try{return JSON.parse(localStorage.getItem(e)||\"null\")}catch{return null}},p=n=>{if(!n)return\"\u2014\";const e=new Date(n);return Number.isNaN(e.getTime())?String(n):new Intl.DateTimeFormat(void 0,{dateStyle:\"medium\",timeStyle:\"short\"}).format(e)},m=n=>[n?.date?.y||\"\",n?.date?.m||\"\",n?.date?.d||\"\",n?.id||\"\",n?.lastupdate||\"\",n?.color||\"\",n?.title||\"\",n?.desc||\"\",n?.bottom_link?\"1\":\"0\",n?.bottom_link_value||\"\"].join(\"|\");async function u(n){const e=await fetch(n,{cache:\"no-store\"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.text()}function k(n){r.issue=n,document.documentElement.style.setProperty(\"--ki-color\",n.color||\"#DE3163\"),d.label.textContent=`${n.title||\"Know Issue Active\"} \u00B7 View issue`,d.title.textContent=n.title||\"Known Issue\",d.meta.textContent=`Last updated: ${p(n.lastupdate)}`,d.body.textContent=n.desc||\"\"}function b(){if(r.issue){if(d.title.textContent=r.issue.title||\"Known Issue\",d.meta.textContent=`Last updated: ${p(r.issue.lastupdate)}`,d.body.textContent=r.issue.desc||\"\",d.footer.innerHTML=\"\",r.issue.bottom_link&&r.issue.bottom_link_value){const[n,e]=r.issue.bottom_link_value.split(\"###\");if(e){const t=document.createElement(\"a\");t.className=\"ki-link ki-primary\",t.href=e,t.target=\"_blank\",t.rel=\"noopener noreferrer\",t.textContent=n||\"Open link\",d.footer.appendChild(t)}}d.backdrop.style.display=\"flex\",r.modalOpen=!0,localStorage.setItem(t,\"0\")}}function y(){d.backdrop.style.display=\"none\",r.modalOpen=!1}function x(){d.wrap.style.display=\"block\"}async function f(){try{if(!await async function(){const e=`${n}\/isissue.txt?alwayrnadomstring=${encodeURIComponent(l())}&v=${encodeURIComponent(l())}`;return\"1\"===(await u(e)).trim()}())return d.wrap.style.display=\"none\",y(),r.issue=null,r.key=\"\",void localStorage.removeItem(t);const i=await async function(){const e=await async function(n){const e=await fetch(n,{cache:\"no-store\"});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()}(`${n}\/knownissues.json?v=${encodeURIComponent(s())}`),t=e?.date?.y,o=e?.date?.m,i=e?.date?.d,a=e?.id,d=`${n}\/${t}\/${o}\/${i}\/${a}.json.txt?lastupdate=${encodeURIComponent((r=e?.lastupdate||\"\",btoa(unescape(encodeURIComponent(String(r??\"\"))))))}&v=${encodeURIComponent(s())}`;var r;const l=function(n){const e=e=>(n.match(new RegExp(`<${e}>([\\\\s\\\\S]*?)<\\\\\/${e}>`,\"i\"))?.[1]||\"\").trim();return{title:e(\"title\")||\"Known Issue\",desc:e(\"desc\")||\"\",bottom_link:\/<bottom_link>\\s*true\\s*<\\\/bottom_link>\/i.test(n),bottom_link_value:e(\"bottom_link_value\")||\"\"}}(await u(d));return{title:l.title,desc:l.desc,bottom_link:l.bottom_link,bottom_link_value:l.bottom_link_value,date:e?.date||{},lastupdate:e?.lastupdate||\"\",id:String(e?.id||\"\"),color:e?.color||\"#DE3163\"}}(),a=m(i),p=c(),f=!p||p.key!==a;o={key:a,issue:i,savedAt:(new Date).toISOString()},localStorage.setItem(e,JSON.stringify(o)),k(i),x(),!f||r.modalOpen&&r.key===a||b(),f||\"1\"!==localStorage.getItem(t)||y(),r.key=a}catch(n){console.error(\"Known issue refresh failed:\",n);const e=c();e?.issue&&(r.issue=e.issue,k(e.issue),x())}var o}d.btn.addEventListener(\"click\",b),d.close.addEventListener(\"click\",y),d.backdrop.addEventListener(\"click\",n=>{n.target===d.backdrop&&y()}),window.addEventListener(\"keydown\",n=>{\"Escape\"===n.key&&y()});const g=c();g?.issue&&(r.issue=g.issue,r.key=g.key||m(g.issue),k(g.issue),x()),f(),setInterval(f,186e3)})();";
