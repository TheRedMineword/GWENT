...
var card_dict_base = [
  ...
  },
  {
    ...
    row: "ranged",
    strength: "0",
    ability: "hero witcher_potion potion_soup",
    filename: "potion_soup",
    count: "0",
    viper_potion: true,
  },
  {
    ...
    row: "ranged",
    strength: "0",
    ability: "hero witcher_potion potion_grom",
    filename: "potion_grom",
    count: "0",
    viper_potion: true,
  },
  {
    ...
    row: "ranged",
    strength: "0",
    ability: "hero potion_white",
    filename: "potion_white",
    count: "0",
    viper_potion: true,
  },
  {
...
function setupSpiritTimer(card, data) {
  card.count_monitor = {
    ...
    msg: data?.when?.sidenotif ?? false, // made it josn config false, // temporary change
