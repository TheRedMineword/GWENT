STRNG["en"] = {
  ...
  ability: {
    ...
    scorchstopper: {
      description:
        "Prevents Scorch effects by spending 1 Shield Charge per saved card. Starts with 5 charges, cannot be recharged, and breaks if you play any Scorch card.",
    },
    agile: {
      name: "agile",
      description:
    ...
    sabotage: {
      name: "sabotage",
      description:
        "Send to enemy fields this cards to lower their score and draw extra 1 card(s). ",
    },
    resilience: {
      name: "Resilience",
    ...
    axii: {
      name: "Witcher Signs",
      description:
        "This card use Witchers tricks to cast into enemy fields Axii sign. Each card in row under Axii effect that base power is less than 5 will lose 2 power. Debuffs dont stack. Dont affect hero cards. ",
    },
    axii2_desc: {
      name: "Axii",
      description:
    ...
    powergain: {
      name: "Power Gain",
      description:
        "Card base power grows by 1.11 for each card in the row (excluding itself). Card base power is not affected by weather, but its bonus power is reduced by 75% under weather effects. Values are rounded down.",
    },
    bond: {
      name: "Tight Bond",
      description:
    ...
    keadwen_weather: {
      description:
        "Play an Impenetrable Fog from your deck. If none is found, still consume leader charge. Let you skip turns, but gives your opponent 50/50 each skip to copy non-hero card from board. You need 1 charge to skip turn, you get 0.2 charges per your turn, up to 1 max charge(s) stored!",
    },
    foltest_lord: {
      description:
    ...
    nilf_drawmaster: {
      description:
        "On use, if your hand has fewer than 3 cards, draw 1 cards from your deck, plus 1 additional card for each unit in your graveyard (up to 3 bonus cards). You start the game with 2 fewer cards in hand but you can on game start redraw extra 1 card(s).",
    },
    temeria_call: {
      description:
    ...
    turn_skiper: {
      description:
        "Let you skip turns, but gives your opponent 50/50 each skip to copy non-hero card from board. You need 1 charge to skip turn, you get 0.35 charges per your turn, up to 2 max charge(s) stored!",
    },
    d20cloner: {
      description:
        "Let you roll D20 for chance to get additional card from board, but what card you can get depends on roll result. Success on even roll. You need 1 charge to roll dice, you get 0.16 charges per your turn, up to 1 max charge(s) stored!",
    },
    gaunter_neutral_leader: {
      description:
        "On use both sides will gain an additional (60%+1)  of the number of cards in the thier grave as additional cards from deck and all players start the game with 50% more cards in their hand (based on their starting number)",
    },
    emhyr_emperor: {
    ...
    skellige_berserk_reward: {
      description:
        "Spawn a Mardroeme card in the row with the most Berserkers.",
    },
  ...
  card: {
        "foltest_copper": "Foltest — King of Temeria",
    "foltest_bronze": "Foltest — Lord Commander of the North",
    "foltest_silver": "Foltest — The Siegemaster",
    "foltest_gold": "Foltest — The Steel-Forged",
    ...
    "eredin_rider": "Eredin — Commander of the Red Riders",
    "eredin_silver": "Eredin — Bringer of Death",
    "eredin_gold": "Eredin — Destroyer of Worlds",
    "eredin_king": "Eredin — King of the Wild Hunt",
    ...
    dopler: "Doppler",
    reveal_dopler: "Doppler Attack Force",
    wshield: "Witchers — Quen",
    ...
    temeriamoral_1: "Blue Stripe Commando — Scout",
    ...
    king_of_beggers: "King of Beggers",
  ...
  ui: {
    elem: {
      "initial_redraw": {
        "txt": "Choose up to %s cards to redraw."
      },
      definesJS: {
        players: {
          me: "You",
...
card_info: {
  ...
  elderblood_female: "Elder Blood",
  magic_male: "Magic",
  magic_female: "Magic",
  monster_male: "Monster",
  monster_female: "Monster",
  warrior_male: "Warrior",
  warrior_female: "Warrior",
  berserker_male: "Berserker",
  berserker_female: "Berserker",
  dwarf_male: "Dwarf",
  dwarf_female: "Dwarf",
  elf_male: "Elf",
  elf_female: "Elf",
  spy_male: "Spy",
  spy_female: "Spy",
  siege_male: "Structures",
  siege_female: "Structures",
  ship_male: "Ship",
  ship_female: "Ship",
  bard_male: "Bard",
  bard_female: "Bard",
  special_male: "Special",
  special_female: "Special",
  event_male: "Event",
  event_female: "Event",
  hebitch_male: "Ordinary Son of a Whore",
  hebitch_female: "Ordinary Daughter of a Whore",
  banner_male: "Banner",
  banner_female: "Banner",
  spicetrader_male: "Spice Merchant",
  spicetrader_female: "Spice Merchant",
  cow_male: "Cow",
  cow_female: "Cow",
  sky_spirit_male: "Spirit",
  sky_spirit_female: "Spirit",
  guard_male: "Guard",
  guard_female: "Guard",
  sky_guide_e_male: "Event Guide",
  sky_guide_e_female: "Event Guide",
  sky_guide_s_male: "Seasonal Guide",
  sky_guide_s_female: "Seasonal Guide",
  sky_skykid_male: "Sky Kid",
  sky_skykid_female: "Sky Kid",
  sky_item_male: "Item",
  sky_item_female: "Item",
  medic_male: "Medic",
  medic_female: "Nurse",
  healer_male: "Healer",
  healer_female: "Healer",
  sabotage_male: "Saboteur",
  sabotage_female: "Saboteur",
  assasin_male: "Assassin",
  assasin_female: "Assassin",
  roach_male: "Roach",
  roach_female: "Roach",
