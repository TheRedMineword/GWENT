...
(function () {
  ...
  function r(a, b) {
    if (b) a: {
      ...
      d = c[a];
      b = b(d);
      b != d && b != null && p(c, a, {configurable: true, writable: true, value: b});
    }
  }
  var t;
  if (typeof Object.setPrototypeOf == "function") t = Object.setPrototypeOf; else {
    var u;
    a: {
      var ea = {a: true}, fa = {};
      try {
  ...
  y.prototype.W = function (a, b) {
    ...
    var c = a.next();
    ja(c);
    if (c.done) this.m = c.value, this.g = b; else return this.j = a, this.u(c.value, b);
  };
  ...
  y.prototype.U = function (a, b) {
    ...
    (b = this.h = this.h || b) ? b.O ? this.g = this.l || this.i : b.C != undefined && this.i < b.C ? (this.g = b.C, this.h = null) : this.g = this.i : this.g = a;
  };
  ...
  function D(a, b, c, d) {
    try {
      ...
      ja(h);
      if (!h.done) return a.g.o = false, h;
      var k = h.value;
    } catch (f) {
  ...
  r("Symbol", function (a) {
    ...
    function c(k, f) {
      this.g = k;
      p(this, "description", {configurable: true, writable: true, value: f});
    }
    if (a) return a;
    c.prototype.toString = function () {
      return this.g;
    };
    var d = "jscomp_symbol_" + (Math.random() * 1e9 >>> 0) + "_", h = 0;
    return b;
  });
  r("Symbol.iterator", function (a) {
    if (a) return a;
    a = Symbol("Symbol.iterator");
    p(Array.prototype, a, {configurable: true, writable: true, value: function () {
      return oa(ia(this));
    }});
    return a;
  });
  ...
  r("Promise", function (a) {
    ...
    b.prototype.G = function (f) {
      if (f === this) this.l(new TypeError("A Promise cannot resolve to itself")); else if (f instanceof b) this.I(f); else {
        a: switch (typeof f) {
          case "object":
            var e = f != null;
            break a;
    ...
    b.prototype.D = function () {
      ...
      var f = q.CustomEvent, e = q.Event, g = q.dispatchEvent;
      if (typeof g === "undefined") return true;
      typeof f === "function" ? f = new f("unhandledrejection", {cancelable: true}) : typeof e === "function" ? f = new e("unhandledrejection", {cancelable: true}) : (f = q.document.createEvent("CustomEvent"), f.initCustomEvent("unhandledrejection", false, true, f));
      f.promise = this;
      f.reason = this.i;
      return g(f);
    };
    ...
    b.all = function (f) {
      ...
      return g.done ? d([]) : new b(function (l, m) {
        ...
        var x = [], B = 0;
        do x.push(undefined), B++, d(g.value).J(w(x.length - 1), m), g = e.next(); while (!g.done);
      });
    };
    return b;
  });
  var pa = typeof Object.assign == "function" ? Object.assign : function (a, b) {
    ...
    for (var c = 1; c < arguments.length; c++) {
      var d = arguments[c];
      if (d) for (var h in d) Object.prototype.hasOwnProperty.call(d, h) && (a[h] = d[h]);
    }
    return a;
  };
  ...
  r("WeakMap", function (a) {
    ...
    if (function () {
      ...
      try {
        var g = Object.seal({}), l = Object.seal({}), m = new a([[g, 2], [l, 3]]);
        if (m.get(g) != 2 || m.get(l) != 3) return false;
        m.delete(g);
        m.set(l, 4);
    ...
    b.prototype.set = function (g, l) {
      ...
      h(g);
      if (!Object.prototype.hasOwnProperty.call(g, f)) throw Error("WeakMap key fail: " + g);
      g[f][this.g] = l;
      return this;
    };
    b.prototype.get = function (g) {
      return d(g) && Object.prototype.hasOwnProperty.call(g, f) ? g[f][this.g] : undefined;
    };
    b.prototype.has = function (g) {
      return d(g) && Object.prototype.hasOwnProperty.call(g, f) && Object.prototype.hasOwnProperty.call(g[f], this.g);
    };
    b.prototype.delete = function (g) {
      return d(g) && Object.prototype.hasOwnProperty.call(g, f) && Object.prototype.hasOwnProperty.call(g[f], this.g) ? delete g[f][this.g] : false;
    };
    return b;
  });
  r("Map", function (a) {
    ...
    function c(e, g) {
      ...
      return oa(function () {
        if (l) {
          ...
          for (; l.next != l.head;) return l = l.next, {done: false, value: g(l)};
          l = null;
        }
    ...
    function d(e, g) {
      ...
      var m = e[0][l];
      if (m && Object.prototype.hasOwnProperty.call(e[0], l)) for (e = 0; e < m.length; e++) {
        var w = m[e];
        if (g !== g && w.key !== w.key || g === w.key) return {id: l, list: m, index: e, entry: w};
      }
      return {id: l, list: m, index: -1, entry: undefined};
    }
    function h(e) {
      this[0] = {};
      this[1] = b();
    ...
    if (function () {
      ...
      try {
        var e = Object.seal({x: 4}), g = new a(v([[e, "s"]]));
        if (g.get(e) != "s" || g.size != 1 || g.get({x: 4}) || g.set({x: 4}, "t") != g || g.size != 2) return false;
        var l = g.entries(), m = l.next();
        if (m.done || m.value[0] != e || m.value[1] != "s") return false;
        m = l.next();
    ...
    h.prototype.set = function (e, g) {
      ...
      l.entry ? l.entry.value = g : (l.entry = {next: this[1], previous: this[1].previous, head: this[1], key: e, value: g}, l.list.push(l.entry), this[1].previous.next = l.entry, this[1].previous = l.entry, this.size++);
      return this;
    };
    h.prototype.delete = function (e) {
      e = d(this, e);
      return e.entry && e.list ? (e.list.splice(e.index, 1), e.list.length || delete this[0][e.id], e.entry.previous.next = e.entry.next, e.entry.next.previous = e.entry.previous, e.entry.head = null, this.size--, true) : false;
    };
  ...
  r("Set", function (a) {
    ...
    if (function () {
      if (!a || typeof a != "function" || !a.prototype.entries || typeof Object.seal != "function") return false;
      try {
        var c = Object.seal({x: 4}), d = new a(v([c]));
        if (!d.has(c) || d.size != 1 || d.add(c) != d || d.size != 1 || d.add({x: 4}) != d || d.size != 2) return false;
        var h = d.entries(), k = h.next();
        if (k.done || k.value[0] != c || k.value[1] != c) return false;
        k = h.next();
        return k.done || k.value[0] == c || k.value[0].x != 4 || k.value[1] != k.value[0] ? false : h.next().done;
      } catch (f) {
        return false;
      }
    }()) return a;
  ...
  r("Array.from", function (a) {
    return a ? a : function (b, c, d) {
      ...
      var h = [], k = typeof Symbol != "undefined" && Symbol.iterator && b[Symbol.iterator];
      if (typeof k == "function") {
        b = k.call(b);
        for (var f = 0; !(k = b.next()).done;) h.push(c.call(d, k.value, f++));
      } else for (k = b.length, f = 0; f < k; f++) h.push(c.call(d, b[f], f));
      return h;
    };
  });
  var H = this || self;
  ...
  var ra = "closure_uid_" + (Math.random() * 1e9 >>> 0), sa = 0;
  function J(a, b) {
    a = a.split(".");
    for (var c = H, d; a.length && (d = a.shift());) a.length || b === undefined ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {} : c[d] = b;
  }
  function ta(a, b) {
    function c() {}
  ...
  K.prototype.dispose = function () {
    this.i || (this.i = true, this.L());
  };
  K.prototype[Symbol.dispose] = function () {
    this.dispose();
  };
  K.prototype.addOnDisposeCallback = function (a, b) {
    this.i ? b !== undefined ? a.call(b) : a() : (this.j || (this.j = []), b && (a = a.bind(b)), this.j.push(a));
  };
  ...
  var Wa = {da: 0, ba: 1, ca: 2, 0: "FORMATTED_HTML_CONTENT", 1: "EMBEDDED_INTERNAL_CONTENT", 2: "EMBEDDED_TRUSTED_EXTERNAL_CONTENT"};
  function N(a, b) {
  ...
  if (ha) ha(N, O); else for (var P in O) if (P != "prototype") if (Object.defineProperties) {
    var Xa = Object.getOwnPropertyDescriptor(O, P);
    Xa && Object.defineProperty(N, P, Xa);
  } else N[P] = O[P];
  N.R = O.prototype;
  function Ya(a) {
    Ra.test(a) && (a.indexOf("&") != -1 && (a = a.replace(La, "&amp;")), a.indexOf("<") != -1 && (a = a.replace(Ma, "&lt;")), a.indexOf(">") != -1 && (a = a.replace(Na, "&gt;")), a.indexOf('"') != -1 && (a = a.replace(Oa, "&quot;")), a.indexOf("'") != -1 && (a = a.replace(Pa, "&#39;")), a.indexOf("") != -1 && (a = a.replace(Qa, "&#0;")));
    return a;
  }
  ;
  var Za, Q;
  a: {
    for (var $a = ["CLOSURE_FLAGS"], R = H, ab = 0; ab < $a.length; ab++) if (R = R[$a[ab]], R == null) {
      Q = null;
      break a;
    }
    Q = R;
  ...
  function db() {
    return Za ? !!T && T.brands.length > 0 : false;
  }
  function eb(a) {
    var b = {};
  ...
  function fb() {
    for (var a = S(), b = RegExp("([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?", "g"), c = [], d; d = b.exec(a);) c.push([d[1], d[2], d[3] || undefined]);
    a = eb(c);
    if (db()) a: {
      if (Za && T) for (b = 0; b < T.brands.length; b++) if ((c = T.brands[b].brand) && c.indexOf("Chromium") != -1) {
        b = true;
        break a;
      }
      b = false;
  ...
  n.P = function (a, b) {
    var c = this.h[a];
    if (c) {
      var d = Array(arguments.length - 1), h = arguments.length, k;
      for (k = 1; k < h; k++) d[k - 1] = arguments[k];
      if (this.u) for (k = 0; k < c.length; k++) h = c[k], hb(this.g[h + 1], this.g[h + 2], d); else {
        this.m++;
        try {
          ...
          if (this.m--, this.l.length > 0 && this.m == 0) for (; c = this.l.pop();) this.M(c);
        }
      }
      return k != 0;
    }
  ...
  function kb(a, b, c) {
    if (Array.isArray(b)) for (var d = 0; d < b.length; d++) kb(a, String(b[d]), c); else b != null && c.push(a + (b === "" ? "" : "=" + encodeURIComponent(String(b))));
  }
  var lb = /#|$/;
  ...
  function ob() {
    return na(new ma(new ka(function (a) {
      var b = a.return;
      var c = gb() >= 119;
      ...
      switch (c.g) {
        ...
        case 2:
          ...
          return c.u(Promise.all(b.map(function (d) {
            var h;
            return na(new ma(new ka(function (k) {
              if (k.g == 1) return k.I(2), k.u(navigator.permissions.query({name: "top-level-storage-access", requestedOrigin: d}), 4);
  ...
  function X(a, b) {
    ...
    this.id = Object.prototype.hasOwnProperty.call(this, ra) && this[ra] || (this[ra] = ++sa);
    ...
    if (a = typeof a === "string" ? c.getElementById(a) : a) {
      ...
      if (!c) {
        ...
        if (xb.yt_embedsEnableIframeSrcWithIntent) {
          var e = e === undefined ? Ua : e;
          a: if (e = e === undefined ? Ua : e, f instanceof L) e = f; else {
            for (a = 0; a < e.length; ++a) if (c = e[a], c instanceof Ta && c.Y(f)) {
              e = new L(f);
              break a;
            }
            e = undefined;
          ...
          if (e instanceof L) if (e instanceof L) e = e.g; else throw Error(""); else e = Va.test(e) ? e : undefined;
          e !== undefined && (b.src = e);
      ...
      this.g = a;
      this.g.id || (this.g.id = "widget" + (Object.prototype.hasOwnProperty.call(this.g, ra) && this.g[ra] || (this.g[ra] = ++sa)));
      V[this.g.id] = this;
  ...
  function Eb(a) {
    if (!a.g || !a.g.contentWindow) return false;
  ...
  function Gb(a) {
    ...
    return document.visibilityState === "hidden" || a < 0.5 ? 1 : a < 0.75 ? 2 : a < 0.85 ? 3 : a < 0.95 ? 4 : a < 1 ? 5 : 6;
  }
  function Cb(a, b) {
    a.B[b] || (a.B[b] = true, Db(a, "addEventListener", [b]));
  }
  n.sendMessage = function (a) {
    ...
    if (this.g.contentWindow) try {
      ...
      if (c.name && c.name === "SyntaxError") c.message && c.message.indexOf("target origin ''") > 0 || console && console.warn && console.warn(c); else throw c;
  ...
  function yb(a, b) {
    ...
    window.location.href && va(["debugjs", "debugcss"], function (h) {
      ...
      b: {
        var e = 0;
        for (var g = h.length; (e = k.indexOf(h, e)) >= 0 && e < f;) {
          var l = k.charCodeAt(e - 1);
          if (l == 38 || l == 63) if (l = k.charCodeAt(e + g), !l || l == 61 || l == 38 || l == 35) break b;
          e += g + 1;
        }
        e = -1;
      }
  ...
  function Ib(a, b) {
    b = v(b);
    for (var c = b.next(), d = {}; !c.done; d = {v: undefined}, c = b.next()) d.v = c.value, a[d.v] || (d.v === "getCurrentTime" ? a[d.v] = function () {
      ...
      return h;
    } : (d.v.search("cue") === 0 || d.v.search("load") === 0) && d.v !== "loadModule" ? a[d.v] = function (h) {
      return function () {
        this.playerInfo = {};
        this.A = {};
    ...
    }(d) : d.v.search("get") === 0 || d.v.search("is") === 0 ? a[d.v] = function (h) {
      return function () {
        var k = h.v, f = 0;
  ...
  n.getVideoEmbedCode = function () {
    var a = "" + Y(this, "host") + zb(this), b = Number(Y(this, "width")), c = Number(Y(this, "height"));
  ...
  function Fb(a, b, c) {
    Z || (Z = {}, Jb = new Set, Lb.addEventListener("message", function (d) {
      a: if (Jb.has(d.origin)) {
        ...
        var k = Z[h.id];
        if (k && d.origin === k.X) switch (d = k.aa, d.m = true, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), k = h.event, h = h.info, k) {
          case "apiInfoDelivery":
            if (I(h)) for (var f in h) h.hasOwnProperty(f) && (d.A[f] = h[f]);
            break;
          case "infoDelivery":
            Hb(d, h);
            break;
          ...
          case "readyToListen":
            ...
            break;
          default:
            d.i.i || (f = {target: d, data: h}, d.i.P(k, f), ub("player." + k, f));
        }
      }
    }));
    Z[b] = {aa: a, X: c};
  ...
  qb.push(function (a) {
    ...
    va(Array.prototype.concat.apply([], arguments), Kb);
  });
